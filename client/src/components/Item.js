...
const Item = ({ data, saved, handleSaveItem, handleUnsaveItem }) => {
    const { id, name, description, rate, freeShipment, img, price, url,siteName } = data
    ...
    return (
        <div className="container" key={name} style={{ margin: '1rem' }}>
                                ...
                                <div className="img-frame">
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            e.currentTarget.setAttribute("onErro",null)
                                        }}
                                    /> 
